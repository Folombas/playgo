...
func (g *Game) GetAppleImg() *ebiten.Image { return g.appleImg }
func (g *Game) GetStrawberryImg() *ebiten.Image { return g.strawberryImg }
func (g *Game) GetOrangeImg() *ebiten.Image { return g.orangeImg }
func (g *Game) GetBananaImg() *ebiten.Image { return g.bananaImg }
func (g *Game) GetPineappleImg() *ebiten.Image { return g.pineappleImg }
func (g *Game) GetGhostFrames() []*ebiten.Image { return g.ghostFrames }
...
func (g *Game) GetRoachFrames() []*ebiten.Image { return g.roachFrames }
